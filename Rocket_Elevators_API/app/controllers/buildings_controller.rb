class BuildingsController < ApplicationController
  ...
  private
    ...
    def building_params
      params.require(:building).permit(:AdressBuilding, :FullNameBuildingAdmin, :EmailAdminBuilding, :PhoneNumberBuildingAdmin, :FullNameTechContact, :TechContactEmail, :TechContactPhone)
    end
end
