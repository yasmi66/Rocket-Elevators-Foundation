  ...
  def create
    ...
    respond_to do |format|
      if @building_detail.save
        format.html { redirect_to building_detail_url(@building_detail), notice: "Building detail was successfully created." }
  ...
  def update
    respond_to do |format|
      if @building_detail.update(building_detail_params)
        format.html { redirect_to building_detail_url(@building_detail), notice: "Building detail was successfully updated." }
